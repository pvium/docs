...
- **Instant payouts** pay recipients when funding confirms. Use them for bounties, refunds, or other payments due now.
...
Use recipient checks, payout review, and payment records to reduce errors before funding and investigate payment outcomes afterward.
