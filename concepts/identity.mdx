...
Use a recipient’s Pvium handle, email address, wallet address, or supported social account to identify them. Pvium looks up the account and wallet associated with that identity.
...
Payees who have connected their accounts to your organization through OAuth appear under **connected accounts** when you add receivers. Select them from the list to add them to a batch.
