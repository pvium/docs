...
## From identity to on-chain payout

```mermaid
flowchart TD
    A["Identity<br/>Pvium handle · Email · Wallet<br/>GitHub · X · Discord · Telegram"]
    B["Pvium Identity Resolution Engine<br/>Cryptographically verifiable identity mapping"]
    C["Wallet address resolution<br/>+ Compliance, AML & sanctions screening"]
    D{"Checks pass?"}
    E["On-chain payout"]
    F["Payout blocked<br/>Correction flow for the recipient"]
