...
The **Connected accounts** tab lists payees who have connected their accounts to your organization through OAuth. Search by name, email, or username, select individually or **Select all**, and set each person's **amount** and **claim date** before adding them.
